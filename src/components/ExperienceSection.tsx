...
import { 
  ...
  Clock, Calendar, MapPin, ExternalLink 
} from 'lucide-react';
    ...
    <section id="experience">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Timeline Line */}
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-border -ml-px md:transform md:-translate-x-px" />
          ...
          <div className="space-y-12">
            {filteredExperiences.map((exp, index) => {
              ...
              return (
                ...
                >
                  {/* Timeline Node */}
                  <div className="absolute left-0 md:left-1/2 -ml-3.5 md:-ml-3.5 md:transform md:-translate-x-1/2 flex items-center justify-center">
                    <div className="w-7 h-7 rounded-full bg-primary z-10 flex items-center justify-center text-primary-foreground">
                  ...
                  <div className={cn(
                    ...
                    <div className="text-sm font-medium text-primary flex items-center md:justify-end">
                      {index % 2 === 0 ? (
                        <>
