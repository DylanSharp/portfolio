...
const App = () => {
    useEffect(() => {
        ...
        const metaTags = [
            {
                name: 'description',
                content: 'Professional portfolio of Dylan Sharp, a skilled Full Stack Developer specializing in modern web technologies.'
            },
            {
                name: 'keywords',
                content: 'full stack developer, web development, frontend, backend, react, javascript, portfolio'
            },
